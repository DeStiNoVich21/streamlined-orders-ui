...
export const Layout = ({ children }) => {
    ...
    const location = useLocation(); // Добавим для подсветки активного пункта
                ...
                <nav className="space-y-4 flex-1">
                    ...
                    {user?.role === 'Admin' && (
                        <div className="pt-4 border-t border-slate-700 mt-4">
                            <p className="text-xs text-slate-500 uppercase mb-2 font-semibold">Администрирование</p>
                ...
                <header className="bg-white shadow-md p-4 flex justify-between items-center px-8 flex-shrink-0">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <button 
                            ...
                            className="bg-rose-500 hover:bg-rose-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition cursor-pointer shadow-sm active:scale-95"
                        >
                            Выйти
                        </button>
                    </div>
